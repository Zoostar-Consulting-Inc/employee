...
public class TimesheetRestController {
	...
	public ResponseEntity<Timesheet> getNew(@AuthenticationPrincipal OidcUser user) {
	...
	public ResponseEntity<Timesheet> postForProcessing(@AuthenticationPrincipal OidcUser user, TimesheetRequest request) {
